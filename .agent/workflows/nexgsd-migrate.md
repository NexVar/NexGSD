...
- `/nexgsd-migrate Add email_verified column to users table`
- `/nexgsd-migrate Rename posts.author to posts.author_id`
- `/nexgsd-migrate Create comments table with foreign key to posts`
...
/nexgsd-execute [N]     -> Continue phase execution
/nexgsd-review          -> Review migration code
```
...
To retry:    Fix the issue and run /nexgsd-migrate again
```
