...
The user should provide a phase number, e.g., `/nexgsd-plan 1`
...
- Is there a CONTEXT.md for this phase? (from /nexgsd-discuss)
- Is there existing RESEARCH.md?
- Are there existing PLAN.md files?

If CONTEXT.md doesn't exist, ask:
"No context captured for Phase [N]. Plans will use research and requirements only. Continue, or run /nexgsd-discuss [N] first to capture your preferences?"
...
/nexgsd-execute [N]    → Execute all plans
```
