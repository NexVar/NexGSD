...
- `/nexgsd-refactor Extract auth logic from pages into shared hooks`
- `/nexgsd-refactor Rename UserProfile component to ProfileCard across codebase`
- `/nexgsd-refactor Split utils.ts into separate modules`
...
/nexgsd-review          -> Review the refactored code
/nexgsd-execute [N]     -> Continue execution
```
