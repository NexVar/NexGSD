...
If PROJECT.md missing or not finalized → STOP. Tell user to run /nexgsd-new-project.
...
Read .agent/agents/nexgsd-planner.md + .agent/agents/nexgsd-project-researcher.md
...
Read .agent/agents/nexgsd-plan-checker.md → validate plan before executing

Step 3: EXECUTE

Read .agent/agents/nexgsd-executor.md + the PLAN.md just created
...
Read .agent/agents/nexgsd-verifier.md
