...
The user should provide a phase number, e.g., `/nexgsd-discuss 1`

If no phase number provided, ask: "Which phase do you want to discuss? Run /nexgsd-progress to see available phases."
...
/nexgsd-plan [N]    → Research and create task plans
```
