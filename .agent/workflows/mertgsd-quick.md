---
description: Execute a small ad-hoc task with MertGSD guarantees (atomic commits, state tracking)
---

# MertGSD Quick — Ad-Hoc Task with Guarantees

Execute small, self-contained tasks with MertGSD's atomic commit and state tracking guarantees without full phase ceremony.
...
The user should provide a description, e.g., `/mertgsd-quick Add dark mode toggle to settings page`
...
**If no `.planning/`:** "No MertGSD project found. Quick mode needs an active project. Run /mertgsd-new-project first."
...
Ready for next task: /mertgsd-quick
```
