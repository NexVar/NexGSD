...
# /mertgsd-no-halluc — Anti-Hallucination Q&A Mode

Activate MertGSD's strict verification engine for general technical questions and discussions. This mode forces the AI to provide evidence for every claim, cite sources, and admit uncertainty instead of guessing.
...
```bash
/mertgsd-no-halluc [Your technical question here]
