...
- This section feeds directly into /mertgsd-plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /mertgsd-plan-phase --gaps with root causes
...
**Creation:** When /mertgsd-verify-work starts new session
